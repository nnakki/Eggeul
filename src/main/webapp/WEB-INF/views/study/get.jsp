...
">
            <p><i class="fas fa-user"></i> 오늘의 이끌이 : ${study.representationName}</p>
...
<div class="container">
    ...
    <div class="main-contents get-body">
        ...
        <div id="info">
            <h4> 일정 정보</h4>
            <pre style="font-family: 'Noto Sans KR'">${study.information}</pre>
        </div>
        ...
        <div id="study-place">
            <div id="onOff">
                ...
                <c:if test="${study.onOff eq 'STOF02'}">
                    <h4>장소</h4>
                    <pre style="font-family: 'Noto Sans KR'; font-weight: bold;">${study.placeId}</pre>
                </c:if>
            </div>
        </div>
    </div>
            ...
            if(result.length > 0) {
                ...
                for(let i = 0 ; i < result.length; i++) {
                    ...
                    if(result[i].picture !== null && result[i].picture !== 'myPicture.jpeg') {
                        ...
                        str += '<img src="/resources/img/profileegg2.png" alt="Avatar" class="avatar">';
                    }

                    // str += '<img src="../../../resources/img/img_avatar2.png" alt="Avatar" class="avatar">';
                    str += '<strong> ' + result[i].userName + '</strong>';
                    if ("${study.representation}" === result[i].userId) str += '<span> 오늘의 이끌이</span>';
                    if ("GRRO01" === result[i].grpRole) str += '<span> </span>';
