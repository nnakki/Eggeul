...
public class MailVO {
    ...
    public MailVO(String receiver, String key, String getServerName){
        this(receiver,"eggeul 인증메일",
                ...
                "                                                <tbody><tr><td rowspan=\"3\" width=\"9\"></td><td style=\"font-weight:bold;font-size:16px;font-family:'돋움',dotum,sans-serif;color:#1b1b1b; text-align:center;\">안녕하세요. Eggeul 입니다.</td></tr>\n" +
                "                                                <tr><td height=\"6\"></td></tr>\n" +
                "                                                <tr><td style=\"font-size:12px;font-family:'돋움',dotum,sans-serif;color:#444;line-height:20px; text-align:center;\">\n" +
                "                                                                        Eggeul  아이디 인증을 다음과 같이 알려드립니다.\n" +
                "                                                                    <br><br>\n" +
                ...
                "                                                    <tbody><tr>\n" +
                                                                            //은지: 배포시 8080 삭제 요망
                "                                                        <a href=\"" + "http://" + getServerName + ":8080" +"/user/auth?id=" + receiver + "&key=" + key + "\" style=\"text-decoration: none;\"><div style=\"border : solid 1px; width : 150px; height : 30px; margin : 50px auto; padding-top : 8px;\n" +
